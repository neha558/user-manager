...
var followerPolicy = {
  body: Joi.object().keys({
    ...
    exp: Joi.any(),
    followId: Joi.string(),
    followerId: Joi.string().required().max(100).messages(_objectSpread(_objectSpread({}, combineValidationMessages(['any.required', 'string.empty'], generateMandatoryFieldMessage('userId'))), {}, {
