...
module.exports = {
  ...
  verificationLinkExpiryDuration:
    process.env.VERIFICATION_LINK_EXPIRY_DURATION_HRS || 24,
  adminEmailId:
    process.env.ADMIN_EMAIL || 'publicpoll.co.in@gmail.com',
  emailVerificationUrl:
    process.env.EMAIL_VERIFICATION_URL ||
    'http://localhost:3000/verify',
  forgotPasswordVerificationUrl:
    process.env.FORGOT_PASSWORD_VERIFICATION_URL ||
    'http://localhost:3000/verify',
  kafkaHost: process.env.KAFKA_ENDPOINT || 'localhost:9092',
  // Should be a string of length 32
  cursorEncryptionSecret:
    process.env.CURSOR_SECRET || 'bl86odo32bmgcyb8obg30lqm3es21j5n',
  ...
  clientSecret:
    ...
    '3e64a911588a5c00f3d447611869985a',
  callbackURL:
    process.env.FACEBOOK_CALLBACK_URL ||
    'http://localhost:3005/user-manager/auth/facebook/callback',
  callbackFailureURL:
    process.env.FACEBOOK_FAILURE_REDIRECT ||
    'https://develop.publicpoll.com/login',

  googleClientID:
    process.env.GOOGLE_CLIENT_ID ||
    '278644148512-0bpvktsv5g7t1pnunv6h09csl2umeqg8.apps.googleusercontent.com',
  googleClientSecret:
    process.env.GOOGLE_CLIENT_SECRET || '0hil5kutn8fC0_HCbb3NUiqF',
  googleCallbackURL:
    process.env.GOOGLE_CALLBACK_URL ||
    'http://localhost:3005/user-manager/auth/google/callback',
