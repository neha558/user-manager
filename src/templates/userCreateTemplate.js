...
PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
  ...
  <head>
    ...
    <title>Welcome PublicPoll</title>
    <link
    ...
    <img style='width: 612px; text-align: center;' src="${imageURL}/assets/email-banner.png" />
      ...
      <div style='text-align: center;padding: 0 50px 50px;' class="font-family-quicksand">
        <div style='text-align: center;' class="description-font-style">
          <span class="poll-title">Welcome</span>
        </div>
        <div>
        <p>
          Thank you for your registration. Please click the button or link to
        ...
        <a
          style="
            ...
            color: #fff;
          "
          href="${emailVerificationUrl}/${emailVerificationCode}"
          target="_blank"
          >Verify Email</a
        >
        </div>
